...
public class ResourceTypesConsts {
	...
	public static final String PRODUCT_ORDER = ResourceTypes.PRODUCT_ORDER;
	...
	public static boolean isFolder(String resourceType) {
		return resourceType.equals(FOLDER) || resourceType.equals(PRODUCT) || resourceType.equals(PRODUCT_ORDER);
	}
