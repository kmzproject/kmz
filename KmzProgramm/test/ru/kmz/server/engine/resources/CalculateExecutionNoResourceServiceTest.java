...
public class CalculateExecutionNoResourceServiceTest extends DataTestEveryNew {
	...
	public void testTemplateShort8() {
		...
		Assert.assertEquals(DateUtils.getOffsetDate(finish, -14), task1.getStart());
		...
		Assert.assertEquals(DateUtils.getOffsetDate(finish, -7), task2.getStart());
		...
		Assert.assertEquals(DateUtils.getOffsetDate(finish, -14), task3.getStart());
		...
		Assert.assertEquals(DateUtils.getOffsetDate(finish, -14), task4.getStart());
